...
@section('contenido')
    <div class="container bg-claro rounded-xl md:w-3/4 lg:w-3/5 md:p-10 p-14 mt-10 mb-24">
        ...
        <div class="flex justify-end  mt-6">
            <a href="https://stripe.com/es" class="flex flex-row items-center gap-3 cursor-pointer" target="_blank">
                <p class="font-semibold">Pago seguro <i class="fa-solid fa-lock text-primario"></i></p>
                <p class="font-semibold flex items-center gap-2">
                    Powered by Stripe
                    <i class="fa-brands fa-cc-stripe text-2xl text-primario"></i>
                </p>
            </a>
